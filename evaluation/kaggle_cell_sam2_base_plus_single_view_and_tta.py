...
NOTEBOOK_TITLE = 'SAM2 Base+ Single View and TTA'
NEED_BASE = True
NEED_TINY = False
...
run_dir = normalize_model("base_plus")
out_dir = pathlib.Path("/kaggle/working/results/02_baseplus_evaluation")
common = [
    "evaluate", "--sam2-repo", SAM2_DIR,
    "--run-dir", run_dir,
...
archive_results(out_dir, "rsase_baseplus_evaluation")