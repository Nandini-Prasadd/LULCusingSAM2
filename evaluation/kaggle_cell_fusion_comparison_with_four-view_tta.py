NOTEBOOK_TITLE = 'Fusion Comparison With Four-View TTA'
NEED_BASE = True
NEED_TINY = True
...
out_dir = pathlib.Path("/kaggle/working/results/04_fusion_with_tta")
run_runner(
    ...
    "--alpha-steps", "21", "--use-tta",
)
archive_results(out_dir, "rsase_fusion_with_tta")