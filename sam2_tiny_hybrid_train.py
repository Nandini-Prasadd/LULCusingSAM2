...
if __name__ == "__main__":
    ...
    # 1 image per GPU. If VRAM permits with the Tiny model, you might be able to bump this up.
    BATCH_SIZE = 2 
    ...
    print("Building Hybrid Attention SAM 2 Tiny Architecture (r=128)...")
    
    SAM2_CHECKPOINT = "/kaggle/working/sam2/checkpoints/sam2_hiera_tiny.pt"
    if not os.path.exists(SAM2_CHECKPOINT):
        SAM2_CHECKPOINT = "/kaggle/working/checkpoints/sam2_hiera_tiny.pt"
    ...
    # ---------------------------------------------------------------------------
    rescue_dir = "/kaggle/working/checkpoints_hybrid_attention_focal_tiny"
