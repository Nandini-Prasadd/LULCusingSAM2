...
MODEL_KIND = 'segformer_b2'
NOTEBOOK_TITLE = 'RSASE Baseline - SegFormer B2'
...
def make_model():
    ...
    model_class = (
        ...
        if MODEL_KIND == "segformer_b2"
        else Mask2FormerForUniversalSegmentation
    )
...
criterion = FocalDiceLoss(num_classes=NUM_CLASSES) if MODEL_KIND == "segformer_b2" else None
...
config = {
    ...
    "loss": "focal_dice" if MODEL_KIND == "segformer_b2" else "native_mask2former_set_prediction_loss",
    "seed": SEED,
