# ============================================================
# RSASE Ablation - Base+ MSP No Attention
# Paste this whole file into one Kaggle notebook cell.
# ============================================================
RUN_VARIANT = 'msp_no_attention'  # fixed for this notebook
NOTEBOOK_TITLE = 'RSASE Ablation - Base+ MSP No Attention'
...
OUT_DIR = f"/kaggle/working/runs/base_plus_{RUN_VARIANT}"
